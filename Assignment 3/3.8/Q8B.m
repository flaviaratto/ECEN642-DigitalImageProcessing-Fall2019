...
subplot(2,3,4);
imshow(final_result);%Result - Unsharp
imwrite(final_result,"\\toaster\homes\f\l\flaviaratto\nt\AccountSettings\Desktop\DIP Assignment\Assignment 3\3.8\Project8a.tif")
title("Sharpened Image using Unsharp Masking")

%Sharpening the image using High Boost filtering
High_Boost=IP_image+(2.5*mask);
subplot(2,3,5);
imshow(High_Boost);%Result - High Boost
