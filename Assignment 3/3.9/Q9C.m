...
%Applying sobel kernel 1 to the original image
filtered_output1=conv2(IP_image,w1);
%Applying sobel kernel 2 to the image obtained from above
filtered_output2=conv2(filtered_output1,w2);
...
title("Original Image filtered using Sobel Kernel 1")

d2 = intScaling4e(output2,"full","floating");
subplot(1,3,3);
imshow(d2);%Sharpened Image using Sobel Kernel 2
title("Previous Resultant Image filtered using Sobel Kernel 2")
